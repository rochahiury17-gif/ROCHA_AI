...
// ============================================================
// ROCHA AI — CONVERSA POR VOZ PREMIUM
// ============================================================

(function conversaPorVoz() {
    ...
    if (!botao || !campo) {
        ...
        console.warn(
            "ROCHA AI: botão de conversa por voz não encontrado."
        );
    ...
    if (!SpeechRecognition) {
        ...
        console.warn(
            "ROCHA AI: reconhecimento de voz não disponível neste navegador."
        );
        ...
        botao.addEventListener(
            ...
            function () {
                ...
                alert(
                    "Seu navegador não oferece suporte à conversa por voz."
                );
    ...
    function atualizarBotao() {
        ...
        if (!ativo) {
            ...
            botao.innerText = "🗣️";
            botao.title = "Iniciar conversa por voz";
            botao.classList.remove("voz-ativa");
            botao.classList.remove("voz-falando");
        ...
        if (falando) {
            ...
            botao.innerText = "🔊";
            botao.title = "ROCHA AI está falando";
            botao.classList.add("voz-falando");
            botao.classList.remove("voz-ativa");
        ...
        botao.innerText = "🔴";
        botao.title = "ROCHA AI está ouvindo";
        botao.classList.add("voz-ativa");
        botao.classList.remove("voz-falando");
    }
        ...
        reconhecimento.onresult =
            async function (evento) {
                ...
                if (
                    ...
                    console.error(
                        "ROCHA AI: enviarMensagem() não encontrada."
                    );
                }
            };
    ...
    function iniciarEscuta() {
        ...
        try {
            ...
            console.log(
                "ROCHA AI: reconhecimento já está ativo."
            );
    ...
    // --------------------------------------------------------
    // INTERCEPTAR RESPOSTAS DA ROCHA AI
    // --------------------------------------------------------
                    ...
                    clone.json()
                        ...
                        .catch(
                            function (erro) {
                                ...
                                console.error(
                                    "ROCHA AI: erro ao ler resposta de voz:",
                                    erro
                                );
